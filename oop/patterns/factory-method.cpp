...
public:
        NYStyleCheesePizza():
                Pizza("NY Style Sauce and Cheeese Pizza",
...
public:
        std::shared_ptr<Pizza> createPizza(PizzaType type) {
                switch (type) {
                case PizzaType::CHEESE_PIZZA: return std::make_shared<NYStyleCheesePizza>();
                default: return std::shared_ptr<Pizza>();
                }
        }
};
...
public:
        std::shared_ptr<Pizza> createPizza(PizzaType type) {
                switch (type) {
                case PizzaType::CHEESE_PIZZA: return std::make_shared<ChicagoStyleCheesePizza>();
                default: return std::shared_ptr<Pizza>();
                }
        }
};
