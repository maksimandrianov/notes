...
public:
        Mocha(shared_ptr<Beverage> b):
                _beverage(b) {}

        string HardCalc() const override {
                return "Motcha HardCalc";
        }
...
public:
        Whip(shared_ptr<Beverage> b):
                _beverage(b) {}

        string HardCalc() const override {
                return "Whip HardCalc";
        }
