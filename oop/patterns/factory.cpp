...
{
 public:
  ThinCrustDough() { std::cout << "ThinCrustDough" << std::endl; }
};

class ExtraThickCrustDough : public Dough
{
 public:
  ExtraThickCrustDough() { std::cout << "ExtraThickCrustDough" << std::endl; }
};
...
{
 public:
  MarinaraSauce() { std::cout << "MarinaraSauce" << std::endl; }
};

class PlumTomatoSauce : public Sauce
{
 public:
  PlumTomatoSauce() { std::cout << "PlumTomatoSauce" << std::endl; }
};
...
int main()
{
  std::unique_ptr<PizzaIngredientFactoryIntrface> nyFactory(
      new NYPizzaIngredientFactory());
  std::unique_ptr<PizzaIngredientFactoryIntrface> chFactory(
